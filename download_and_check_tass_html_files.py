...
from parse_tass_offline import main_check_downloaded_files, number_of_pages
...
def save_responce_as_html(url, path_to_html_files):
...
def page_pagination(page_number, path_to_html_files):
    ...
    url = quote(url, safe=':/')
    save_responce_as_html(url, path_to_html_files)
